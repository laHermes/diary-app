...
export const TagsHeader = tw.p<any>`px-4 pt-4 font-medium text-left`;
...
export const TagsInput = tw.input<any>`w-full h-12 text-sm tracking-wider bg-transparent border-0 text-zinc-800 placeholder-zinc-400 focus:ring-0`;
