...
export const StyledSidebarButton = tw.button<any>`inline-flex justify-center w-full gap-3 px-6 py-6 text-center transition-all duration-200 rounded-full md:justify-start hover:bg-slate-100 hover:dark:bg-slate-800`;
